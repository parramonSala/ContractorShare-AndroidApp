...
//            client.post(webServiceUrl, params, new AsyncHttpResponseHandler(Looper.getMainLooper()) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            // TODO: Call ContractorShare restful image web service
           /* RequestParams requestParams = new RequestParams();
            requestParams.add("email", mEmail);
            requestParams.add("password", mPassword);
