...
public class MessageAdapter extends BaseAdapter {
    ...
    public MessageAdapter(Activity context, List<Message> chatMessages, int loggedUserId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        boolean myMsg = chatMessage.getFromUserId().equals(loggedUserId);
        //to simulate whether it me or other sender
        setAlignment(holder, myMsg);
        holder.txtMessage.setText(chatMessage.getMessage());
        holder.txtInfo.setText(DateHandler.fromWCFToAndroidDateConverter(chatMessage.getCreated()));
